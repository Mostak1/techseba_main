                                                                        ...
                                                                        <div class="crancy__item-group">
                                                                            ...
                                                                            <div class="crancy__item-form--group">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-12">
                                                                                        <div class="crancy__item-form--group  mg-top-form-20">
                                                                                            <label class="crancy__item-label">{{ __('translate.Blog Type') }}</label>
                                                                                            <select class="form-select crancy__item-input" name="blog_type" id="blog_type">
                                                                                                <option {{ $general_setting->blog_type == 'all' ? 'selected' : '' }} value="all">{{ __('translate.All') }}</option>
                                                                                                <option {{ $general_setting->blog_type == 'default' ? 'selected' : '' }} value="default">{{ __('translate.Default') }}</option>
                                                                                                <option {{ $general_setting->blog_type == 'grid' ? 'selected' : '' }} value="grid">{{ __('translate.Grid') }}</option>
                                                                                            </select>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-12">
                                                                                        <div class="crancy__item-form--group  mg-top-form-20">
                                                                                            <label class="crancy__item-label">{{ __('translate.Portfolio Type') }}</label>
                                                                                            <select class="form-select crancy__item-input" name="portfolio_type" id="portfolio_type">
                                                                                                <option {{ $general_setting->portfolio_type == 'all' ? 'selected' : '' }} value="all">{{ __('translate.All') }}</option>
                                                                                                <option {{ $general_setting->portfolio_type == 'default' ? 'selected' : '' }} value="default">{{ __('translate.Default') }}</option>
                                                                                                <option {{ $general_setting->portfolio_type == 'grid' ? 'selected' : '' }} value="grid">{{ __('translate.Grid') }}</option>
                                                                                            </select>
                                                                                        </div>
                                                                                    </div>
