                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="number" step="0.01" name="price" id="price" value="{{ $listing->price }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="custom_template" id="custom_template" value="{{ $listing->custom_template }}" placeholder="e.g. frontend.services.website_development">
                                                        <small class="text-muted" style="display: block; margin-top: 5px; color: #666;">
                                                            Leave empty to use the default dynamic layout (<code>service_detail.blade.php</code>). To use a static blade layout, enter the blade view path (e.g. <code>frontend.services.website_development</code>).
                                                        </small>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-4 mg-top-form-20">
                                                        <div class="p-3 border rounded bg-light">
                                                            ...
                                                            <div class="crancy__item-form--group mg-top-form-10">
                                                                ...
                                                                <input class="crancy__item-input" type="text" name="plans[{{ $index }}][name]" value="{{ $plan['name'] ?? $plan_name }}">
                                                            </div>
                                                            <div class="crancy__item-form--group mg-top-form-10">
                                                                <label class="crancy__item-label">{{ __('translate.Plan Price') }}</label>
                                                                <input class="crancy__item-input" type="text" name="plans[{{ $index }}][price]" value="{{ $plan['price'] ?? '' }}">
                                                            </div>
                                                            <div class="crancy__item-form--group mg-top-form-10">
                                                                <label class="crancy__item-label">{{ __('translate.Plan Description') }}</label>
                                                                <textarea class="crancy__item-input crancy__item-textarea" style="height: 80px;" name="plans[{{ $index }}][description]">{{ $plan['description'] ?? '' }}</textarea>
                                                            </div>
                                                            <div class="crancy__item-form--group mg-top-form-10">
                                                                <label class="crancy__item-label">{{ __('translate.Plan Features (One per line)') }}</label>
                                                                <textarea class="crancy__item-input crancy__item-textarea" style="height: 120px;" name="plans[{{ $index }}][features]">{{ $plan['features'] ?? '' }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
