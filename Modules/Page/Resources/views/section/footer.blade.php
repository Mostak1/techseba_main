...
@section('body-header')
    ...
    <p class="crancy-header__text">{{ __('translate.Manage Section') }} >> {{ __('translate.Footer Information') }}</p>
@endsection
                                    ...
                                    <div class="col-12 mg-top-30">
                                        ...
                                        <div class="crancy-product-card">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        <label class="crancy__item-label"><i class="fab fa-facebook-f"></i> {{ __('translate.Facebook') }} </label>
                                                        <input class="crancy__item-input" type="text" name="facebook" value="{{ $footer->facebook }}">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        <label class="crancy__item-label"><i class="fab fa-youtube"></i> {{ __('translate.Youtube') }} </label>
                                                        <input class="crancy__item-input" type="text" name="youtube" value="{{ $footer->youtube }}">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        <label class="crancy__item-label"><i class="fab fa-tiktok"></i> {{ __('translate.Tiktok') }} </label>
                                                        <input class="crancy__item-input" type="text" name="tiktok" value="{{ $footer->tiktok }}">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        <label class="crancy__item-label"><i class="fab fa-linkedin-in"></i> {{ __('translate.Linkedin') }} </label>
