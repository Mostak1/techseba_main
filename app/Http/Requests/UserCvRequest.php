...
class UserCvRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'technical_challenge' => ['nullable', 'string', 'max:5000'],
            'built_from_scratch' => ['nullable', 'string', 'max:5000'],
            'proficiency_ratings' => ['nullable', 'array'],
            'proficiency_ratings.php' => ['nullable', 'integer', 'min:1', 'max:5'],
            'proficiency_ratings.javascript' => ['nullable', 'integer', 'min:1', 'max:5'],
            'proficiency_ratings.sql' => ['nullable', 'integer', 'min:1', 'max:5'],
            'proficiency_ratings.redis' => ['nullable', 'integer', 'min:1', 'max:5'],
            'proficiency_ratings.css' => ['nullable', 'integer', 'min:1', 'max:5'],
            'proficiency_ratings.other_languages' => ['nullable', 'integer', 'min:1', 'max:5'],
            'proficiency_ratings.elasticsearch' => ['nullable', 'integer', 'min:1', 'max:5'],
            'proficiency_ratings.laravel' => ['nullable', 'integer', 'min:1', 'max:5'],
            'proficiency_ratings.php_description' => ['nullable', 'string', 'max:2000'],
            'proficiency_ratings.javascript_description' => ['nullable', 'string', 'max:2000'],
            'proficiency_ratings.sql_description' => ['nullable', 'string', 'max:2000'],
            'proficiency_ratings.redis_description' => ['nullable', 'string', 'max:2000'],
            'proficiency_ratings.css_description' => ['nullable', 'string', 'max:2000'],
            'proficiency_ratings.other_languages_description' => ['nullable', 'string', 'max:2000'],
            'proficiency_ratings.elasticsearch_description' => ['nullable', 'string', 'max:2000'],
            'proficiency_ratings.laravel_description' => ['nullable', 'string', 'max:2000'],
            'sparks_joy' => ['nullable', 'string', 'max:5000'],
