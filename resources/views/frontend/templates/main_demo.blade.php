        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="optech-hero-thumb optech-hero-thumb-main-demo " data-aos="fade-up" data-aos-duration="700">
                        <img src="{{ url(@$contactUsContent->data_values['images']['hero_image']) }}" alt="Hero Image" class="optech-hero-thumb-img">
                    </div>
                </div>
            </div>
        </div>
